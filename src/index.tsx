...
<div class="tabs-bar" id="main-tabs" style="display:none">
  ...
  <button class="tab-btn" id="tab-clawbot" style="border-color:rgba(6,182,212,.25);display:flex;align-items:center;gap:5px"><img src="/static/clawbot-mascot.png" style="width:16px;height:16px;object-fit:contain;border-radius:3px;display:block;flex-shrink:0"><span style="background:linear-gradient(135deg,#a855f7,#06b6d4);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-weight:900">ClawFlow</span></button>
