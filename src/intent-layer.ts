...
export const IMAGE_MODEL_REGISTRY: Record<ImageProvider, ImageModelSpec> = {
  // ── Google Image Models (GOOGLE_AI_KEY) ─────────────────────────────────────
  ...
  // ── Replicate Image Models (REPLICATE_API_KEY) ──────────────────────────────
  ...
  sd35:       { id: 'sd35',       name: 'Stable Diffusion 3.5', provider: 'Stability AI',  description: 'Open-source powerhouse — customizable & community-driven',  apiEndpoint: 'https://api.replicate.com/v1/models/stability-ai/stable-diffusion-3.5-large/predictions', envKey: 'REPLICATE_API_KEY' },
  sd35_medium:{ id: 'sd35_medium', name: 'SD 3.5 Medium',    provider: 'Stability AI',     description: 'Faster SD 3.5 — great balance of speed and quality',         apiEndpoint: 'https://api.replicate.com/v1/models/stability-ai/stable-diffusion-3.5-medium/predictions',envKey: 'REPLICATE_API_KEY' },
  ...
  seedream:   { id: 'seedream',   name: 'Seedream 3',         provider: 'Bytedance',        description: 'High-quality, fast generation from Bytedance',               apiEndpoint: 'https://api.replicate.com/v1/models/bytedance/seedream-3/predictions',               envKey: 'REPLICATE_API_KEY' },
  runway_img: { id: 'runway_img', name: 'Runway Gen-4 Image', provider: 'Runway ML',        description: 'Reference-based image generation with up to 3 ref images',   apiEndpoint: 'https://api.replicate.com/v1/models/runwayml/gen4-image/predictions',               envKey: 'REPLICATE_API_KEY' },
};
...
export const VIDEO_MODEL_REGISTRY: Record<VideoProvider, VideoModelSpec> = {
  ...
  kling26:     { id: 'kling26',     name: 'Kling 2.6',          provider: 'Kuaishou',    description: 'Latest Kling — precise character motion control',       apiEndpoint: 'https://api.replicate.com/v1/models/kwaivgi/kling-v2.6-motion-control/predictions',           envKey: 'REPLICATE_API_KEY', maxDuration: 10 },
